...
NDefines.NGraphics.PROVICHE_NAME_DRAW_DISTANCE = 1000.0 			-- Remove province names beyond this distance
...
NDefines.NSupply.CAPITAL_STARTING_PENALTY_PER_PROVICHE = 0.3 -- starting penalty that will be added as supply moves away from its origin (modified by stuff like terrain)
NDefines.NSupply.CAPITAL_ADDED_PENALTY_PER_PROVICHE = 0.4 -- added penalty as we move away from origin
NDefines.NSupply.NODE_INITIAL_SUPPLY_FLOW = 2.0
NDefines.NSupply.NODE_STARTING_PENALTY_PER_PROVICHE = 0.3
NDefines.NSupply.NODE_ADDED_PENALTY_PER_PROVICHE = 0.4
...
NDefines.NSupply.NAVAL_BASE_STARTING_PENALTY_PER_PROVICHE = 0.6
NDefines.NSupply.NAVAL_BASE_ADDED_PENALTY_PER_PROVICHE = 0.6
...
NDefines.NGraphics.MINIMUM_PROVICHE_SIZE_IN_PIXELS = 4
